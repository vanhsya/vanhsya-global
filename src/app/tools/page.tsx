...
const ToolsPage: React.FC = () => {
  const tools: Tool[] = [
    ...
    },
    {
      ...
      title: 'Processing Time Tracker (Coming Soon)',
      description: 'Processing time monitoring is being finalized. Contact us to join the early-access list for live updates by visa category and country.',
      icon: <FaClock className="w-6 h-6" />,
      href: '/tools/processing-time-tracker',
      category: 'tracking',
      difficulty: 'easy',
      estimatedTime: '2-5 minutes',
      features: ['Live updates', 'Historical trends', 'Alerts', 'Multiple countries'],
      popular: false
    },
    {
      id: 'cost-calculator',
      title: 'Immigration Cost Calculator (Coming Soon)',
      description: 'The cost estimator is under final QA. Contact us to join early access for country-by-country fee breakdowns and budgeting.',
      icon: <FaDollarSign className="w-6 h-6" />,
      href: '/tools/cost-calculator',
      category: 'calculation',
      difficulty: 'medium',
      estimatedTime: '15-20 minutes',
      features: ['Fee breakdown', 'Currency conversion', 'Budget planning', 'Comparisons'],
      popular: false
    },
    {
      id: 'points-calculator',
      title: 'Points Calculator (Express Entry) (Coming Soon)',
      description: 'The CRS calculator is being validated against the latest criteria. Contact us to get notified when it launches.',
      icon: <FaChartLine className="w-6 h-6" />,
      href: '/tools/points-calculator',
      category: 'calculation',
      difficulty: 'medium',
      estimatedTime: '10-15 minutes',
      features: ['CRS scoring', 'Factor analysis', 'Optimization tips', 'Recommendations'],
      popular: false
    },
    {
      id: 'language-test-planner',
      title: 'Language Test Planner (Coming Soon)',
      description: 'The test planner is being finalized. Contact us to join early access for test comparisons, timelines, and score targets.',
      icon: <FaGraduationCap className="w-6 h-6" />,
      href: '/tools/language-test-planner',
      category: 'planning',
      difficulty: 'medium',
      estimatedTime: '10-15 minutes',
      features: ['Test comparisons', 'Score requirements', 'Preparation timeline', 'Planning'],
      popular: false
    },
    {
      id: 'visa-comparison',
      title: 'Visa Pathway Comparison (Coming Soon)',
      description: 'The comparison module is in final review. Contact us to get early access to side-by-side pathway analysis.',
      icon: <FaPassport className="w-6 h-6" />,
      href: '/tools/visa-comparison',
      category: 'assessment',
      difficulty: 'advanced',
      estimatedTime: '20-30 minutes',
      features: ['Side-by-side comparison', 'Eligibility analysis', 'Timeline comparison', 'Trade-offs'],
      popular: false
    },
    {
      id: 'application-tracker',
      title: 'Application Status Tracker (Coming Soon)',
      description: 'Status tracking is being finalized. Contact us to join early access for stage guidance and next-step prompts.',
      icon: <FaFileAlt className="w-6 h-6" />,
      href: '/tools/application-tracker',
      category: 'tracking',
      difficulty: 'easy',
      estimatedTime: '5 minutes setup',
      features: ['Status monitoring', 'Stage explanations', 'Next steps', 'Timelines'],
      popular: false
    }
  ];
